...
export function ProductCard({
  ...
  return (
    <Card className="border rounded-lg transition-transform transform hover:scale-105 hover:shadow-xl duration-300"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
      <div className="overflow-hidden rounded-t-lg">
        <CardHeader className="h-64 relative overflow-hidden" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          <Link href={`/shop/${id}`}>
          <Image
            width={668}
            height={668}
      ...
      <CardBody className="p-4"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
        ...
        >
          <Typography variant="h5" className="mb-2 font-bold normal-case text-gray-800"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            {name}
          </Typography>
        </a>
        ...
        <Typography className="mb-6 font-normal text-gray-500" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          ...
          variant="outlined"
          onClick={() => addToCart({ id, name, price, image, quantity })} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
